...
log(WARNING, string.format("memory: WEAPON_PRODUCIBLE: %X", weaponProducibleAddr))
...
log(WARNING, string.format("memory: WEAPON_SAVE_PRODUCIBLE: %X", weaponProducibleSaveAddr))
